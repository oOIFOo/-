...
signal(1:CHIRP_LEN) = chirp(time, CHIRP_FREQ_START, time(end), CHIRP_FREQ_END);     % £Gt = 0.00~0.025(s)
...
ss = SensingServer(SERVER_PORT, @LatencyEstimateCallback, SensingServer.DEVICE_AUDIO_MODE_PLAY_AND_RECORD, as);
